...
const Footer = () => {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className="relative w-full bg-aira-darkBlue overflow-hidden"
    >
                ...
                {footerConfig.socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      key={social.label}
                      href={social.href}
                      className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/60 hover:text-aira-lime hover:border-aira-lime/50 transition-colors"
              ...
              <ul className="space-y-3">
                {footerConfig.quickLinks.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-sm text-white/50 hover:text-aira-lime transition-colors flex items-center gap-2 group"
                    >
                      <span>{link}</span>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${footerConfig.email}`} className="text-sm text-white hover:text-aira-lime transition-colors">
                      {footerConfig.email}
                    </a>
                  </div>
                </li>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-grow px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-aira-lime/50"
                />
                <button
                  onClick={handleContactClick}
                  className="px-4 py-3 bg-aira-lime text-aira-darkBlue rounded-lg text-sm font-medium hover:bg-aira-lime/80 transition-colors"
                >
