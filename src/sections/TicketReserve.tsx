      ...
      >
        ...
        <div className="relative z-10 flex-none border-b border-white/10 px-5 py-4 md:px-8 md:py-5 flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <h3 className="font-display text-2xl md:text-4xl text-white leading-none truncate">
              {selectedEvent.venue}
            </h3>
              ...
              >
                <div
                  className={
                    ...
                    (completed ? 'bg-aira-lime text-aira-darkBlue' :
                     active    ? 'bg-aira-blue text-white' :
                ...
                <span
                  className={
                    'font-mono-custom text-[10px] uppercase tracking-[0.22em] ' +
                    ...
                    {TICKETS.map(ticket => (
                      ...
                      >
                        <div
                          ...
                          style={{ background: `${ticket.accentColor}20`, color: ticket.accentColor }}
                        >
                          {ticket.icon}
                        </div>
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <h5 className="font-display text-xl text-white">{ticket.name}</h5>
                          <span className="font-display text-base shrink-0" style={{ color: ticket.accentColor }}>
                            {fmt(ticket.price)}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {ticket.perks.map(perk => (
                            <span
                              ...
                              style={{
                                borderColor: `${ticket.accentColor}35`,
                                color: ticket.accentColor,
                                background: `${ticket.accentColor}10`,
                              }}
                            >
                              {perk}
                            </span>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          <span
                            ...
                            style={{
                              borderColor: `${selectedTicket.accentColor}35`,
                              color: selectedTicket.accentColor,
                              background: `${selectedTicket.accentColor}10`,
                            }}
                          >
                            {selectedTicket.name}
                          </span>
                    ...
                    <div className="space-y-2 border-t border-white/10 pt-4">
                      ...
                      <div className="flex justify-between pt-2 border-t border-white/10">
                        ...
                        <span className="font-display text-2xl" style={{ color: selectedTicket.accentColor }}>
                          {fmt(total)}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    ...
                    {selectedTicket && (
                      <span
                        ...
                        style={{
                          background: `${selectedTicket.accentColor}15`,
                          color: selectedTicket.accentColor,
                        }}
                      >
                        {selectedTicket.name}
