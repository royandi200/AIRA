...
export const siteConfig: SiteConfig = {
  ...
  description: "Experimenta la magia de AIRA, el festival de música electrónica más esperado en Guatapé, Colombia.",
  language: "es",
};
...
export const albumCubeConfig: AlbumCubeConfig = {
  albums: [
    { id: 1, title: "MAIN STAGE", subtitle: "EXPERIENCIA", image: "/main-stage.jpg" },
    { id: 2, title: "BEACH STAGE", subtitle: "NATURALEZA", image: "/beach-party.jpg" },
    { id: 3, title: "YACHT PARTY", subtitle: "EXCLUSIVIDAD", image: "/yacht-party.jpg" },
    { id: 4, title: "VIP LOUNGE", subtitle: "LUJO", image: "/vip-area.jpg" },
  ],
  cubeTextures: ["/cube-1.jpg","/cube-2.jpg","/cube-3.jpg","/cube-4.jpg","/cube-5.jpg","/cube-6.jpg"],
  scrollHint: "Desplaza para explorar",
};

export interface ParallaxImage { id: number; src: string; alt: string; }
export interface GalleryImage { id: number; src: string; title: string; date: string; }
...
export const parallaxGalleryConfig: ParallaxGalleryConfig = {
  ...
  marqueeTexts: ["GUATAPÉ","MÚSICA ELECTRÓNICA","NATURALEZA","EXPERIENCIA ÚNICA","COLOMBIA","FIESTA","AIRA","ELECTRONIC MUSIC"],
...
export interface TourDate {
  id: number; date: string; time: string; city: string; venue: string;
  status: "on-sale" | "sold-out" | "coming-soon"; image: string;
}

export interface TourStatusLabels {
  onSale: string; soldOut: string; comingSoon: string; default: string;
}

export interface TourScheduleConfig {
  sectionLabel: string; sectionTitle: string; vinylImage: string;
  buyButtonText: string; detailsButtonText: string; bottomNote: string;
  bottomCtaText: string; statusLabels: TourStatusLabels; tourDates: TourDate[];
}
...
export const tourScheduleConfig: TourScheduleConfig = {
  ...
  statusLabels: { onSale: "DISPONIBLE", soldOut: "AGOTADO", comingSoon: "PRÓXIMAMENTE", default: "RESERVAR" },
  tourDates: [
    { id: 1, date: "2025.08.15", time: "18:00", city: "GUATAPÉ", venue: "ENTRADA GENERAL - DÍA 1", status: "on-sale", image: "/stage-1.jpg" },
    { id: 2, date: "2025.08.16", time: "18:00", city: "GUATAPÉ", venue: "ENTRADA GENERAL - DÍA 2", status: "on-sale", image: "/main-stage.jpg" },
    { id: 3, date: "2025.08.17", time: "18:00", city: "GUATAPÉ", venue: "ENTRADA GENERAL - DÍA 3", status: "on-sale", image: "/beach-party.jpg" },
    { id: 4, date: "2025.08.15", time: "20:00", city: "GUATAPÉ", venue: "PAQUETE VIP - 3 DÍAS", status: "on-sale", image: "/vip-area.jpg" },
    { id: 5, date: "2025.08.16", time: "14:00", city: "EMBALSE", venue: "YACHT PARTY EXPERIENCE", status: "coming-soon", image: "/yacht-party.jpg" },
    { id: 6, date: "2025.08.17", time: "12:00", city: "GUATAPÉ", venue: "BACKSTAGE EXPERIENCE", status: "sold-out", image: "/dj-console.jpg" },
  ],
};

export interface FooterImage { id: number; src: string; }
export interface SocialLink { icon: "instagram" | "twitter" | "youtube" | "music"; label: string; href: string; }

export interface FooterConfig {
  portraitImage: string; portraitAlt: string; heroTitle: string; heroSubtitle: string;
  artistLabel: string; artistName: string; artistSubtitle: string; brandName: string;
  brandDescription: string; quickLinksTitle: string; quickLinks: string[];
  contactTitle: string; emailLabel: string; email: string; phoneLabel: string;
  phone: string; addressLabel: string; address: string; newsletterTitle: string;
  newsletterDescription: string; newsletterButtonText: string; subscribeAlertMessage: string;
  copyrightText: string; bottomLinks: string[]; socialLinks: SocialLink[]; galleryImages: FooterImage[];
}
...
export const footerConfig: FooterConfig = {
  ...
  brandName: "AIRA",
  brandDescription: "El festival de música electrónica que fusiona la energía de la música con la magia natural de Guatapé, Colombia.",
  ...
  subscribeAlertMessage: "¡Gracias por suscribirte!",
