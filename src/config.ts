...
export const parallaxGalleryConfig: ParallaxGalleryConfig = {
  ...
  galleryImages: [
    ...
    },
    {
      ...
      accent: "#FF6B35",
      description: "Ubicado en la playa del hotel, el AIRA Stage es el corazón social de AIRA. Música desde el mediodía, zona de descanso, food trucks y el agua del embalse a pasos de distancia.",
    ...
    },
    {
      ...
      accent: "#B06EFF",
      description: "El primer impacto cuando llegas a AIRA. Punto de encuentro, actividades de bienestar en las mañanas y música sin parar desde el mediodía hasta que todos migran al Japi Stage.",
      detail: "El Joinn Stage conecta todas las áreas del festival. Meditación y yoga en la mañana. Música en vivo desde el mediodía. Punto de reunión antes de cada sesión en el Japi Stage.",
