...
export const parallaxGalleryConfig: ParallaxGalleryConfig = {
  ...
  galleryImages: [
    ...
    },
    {
      ...
      detail: "El Lobby Stage conecta todas las áreas del festival. Meditación y yoga en la mañana. Música en vivo desde el mediodía. Punto de reunión antes de cada sesión en el Japi Stage.",
